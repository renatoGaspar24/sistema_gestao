...
class _CadastroProdutoPageState extends State<CadastroProdutoPage> {
  ...
  Uint8List?
  _webImageBytes; // Adicionado para armazenar os bytes da imagem (Web)
  ...
  void _salvar() async {
    ...
    final novo = Produto(
      ...
      imagemPath:
          imagemFinal, // Agora este campo pode ser Base64 OU um caminho de Asset
        ...
        child: Column(
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: _buildTextField(_preco, "Preço", isNumber: true),
                ),
